<template>
  <div class="pa-4">
    ...
    <v-row class="mb-4" align="center">
      <v-col cols="12" sm="4">
        <v-text-field v-model="selectedDate" label="Select Date" type="date" @change="fetchReportData"></v-text-field>
      </v-col>
    </v-row>
    ...
    <!-- Data Table -->
    <v-data-table :headers="headers" :items="reportData" :items-per-page="5" class="elevation-1">
