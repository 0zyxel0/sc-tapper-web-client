    ...
    <v-sheet class="mx-auto bg-deep-purple pa-12" width="750" rounded>
      <v-form v-model="valid" ref="loginForm" lazy-validation>
        <v-card>
          <v-card-text>
            ...
            <v-row>
              <v-col cols="6">
                ...
                <v-img :src="avatarImage ? imagePreviewURL : 'https://fakeimg.pl/400x400?text=Photo'" alt=""
                  lazy-src="https://fakeimg.pl/400x400?text=Photo" style="max-width: 100%; object-fit: cover"
                  height="40vh" />

                <v-file-input v-model="avatarImage" accept="image/png, image/jpeg, image/bmp" label="Image" required
          ...
          <v-card-actions>
            <v-btn class="mt-4" color="primary" variant="outlined" size="large" block
